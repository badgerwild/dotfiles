...
#alias for my git repo for dot files
alias config='/usr/bin/git --git-dir=/home/jason/.cfg/ --work-tree=/home/jason'
alias robo='cd Programming/robotics-prototype && source venv/bin/activate && cd robot'
alias encs='ssh j_klimo@login.encs.concordia.ca'
alias act='source bin/activate'
alias unreal='cd UnrealEngine/Engine/Binaries/Linux && ./UE4Editor -opengl4'


#------ ROBOTICS SETTINGS ------
# competition mode
#export ROS_MASTER_URI=http://172.16.1.30:11311
#export ROS_HOSTNAME=jason
# local mode
...
export ARDUINO_PATH=/home/jason/arduino-1.8.12
